    ...
    private void startAnimation(final View v) {
        v.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                FloatingElement floatingElement = new FloatingBuilder().anchorView(v).targetView(imageView).floatingTransition(new PlaneFloating()).offsetY(60).build();
